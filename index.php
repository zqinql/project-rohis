...
<?php require_once 'partials/nav.php' ?>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="hero pb-3">
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          <h2>Hii 👋👋, Welcome to <span>IRMA</span></h2>
          <p>Ikatan Remaja Masjid SMK Binakarya Mandiri atau biasa yang dikenal Rohis.</p>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="admin" class="btn-get-started">Ruang Admin</a>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>About Us</h2>
          <p> IRMA adalah sebuah organisasi islami yang berdiri dibawah naungan SMK Binakarya Mandiri Bekasi.
        ...
        <div class="row gy-4 justify-content-between">
          ...
          <div class="col-lg-4">
            <div class="content ps-0 ps-lg-5">
                <div class="kotak p-3 rounded-3" style="background-color:  #f1f5f9;">
                  <h3 class="text-success"> <span>Tautan</span> </h3>
                  <a href="tentang#activities"><h4 class="py-1 ps-3" id="link-tautan">Aktivitas</h4></a>
                  <a href="tulisan" ><h4 class="py-1 ps-3" id="link-tautan">Tulisan</h4></a>
                  <a href="rapat-keanggotaan#qna"><h4 class="py-1 ps-3" id="link-tautan">Qna</h4></a>
                  <a href="rapat-keanggotaan#ide" ><h4 class="py-1 ps-3" id="link-tautan">Tuangkan ide kamu!</h4></a>
                </div>
            </div>
          </div>
        </div>
