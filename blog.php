        ...
        <?php foreach($blog as $row) : ?>
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="img/<?=$row['image']?>" alt="img/<?=$row['image']?>" class="img-fluid">
              </div>

              <p class="post-category">Politics</p>

              <h2 class="title">
                <a href="blog-details.php?id=<?=$row['no']?>"><?=$row['judul']?></a>
              </h2>

              <div class="d-flex align-items-center">
                <img src="assets/img/blog/blog-author.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
                  <p class="post-author-list"><?=$row['nama']?></p>
                  <p class="post-date">
                    <time datetime="2022-01-01"><?=$row['tgl_upload']?></time>
                  </p>
                </div>
              </div>
